...
### 🧭 여행 성향 분석 (Personality Test)
- **12문항 성향 테스트**: Big Five 성격 이론, Plog의 여행자 성향 이론 기반
- **8가지 여행 유형**: 철두철미한 인간 엑셀, 자유로운 프로 방랑러, 에너지 충전 칩거형 등
- **맞춤형 추천**: 성향에 따른 관광지, 숙소, 액티비티, 카페 추천
- **결과 저장**: 사용자별 성향 테스트 결과 저장 및 이력 관리
