...
// (1-2) Qdrant → MongoDB 임포트 (백그라운드 실행)
router.post('/import-from-qdrant', productController.importFromQdrant);
router.get('/import-status', productController.getImportStatus);
